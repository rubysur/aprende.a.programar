...
sólo hace una nueva versión de éste en reversa. Esto es porque `var1` continúa
...
centrar las líneas de un poema, debería hacer algo como esto:
...
de 1. Vamos a ver cómo es que trabaja en un programa:
...
random de números incluso en la misma secuencia en dos ejecuciones diferentes 
